The original Wisconsin-Breast Cancer (Diagnostics) dataset (WBC) from the UCI machine learning repository is a classification dataset that records breast cancer case measurements.
